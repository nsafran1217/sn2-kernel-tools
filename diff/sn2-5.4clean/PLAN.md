...
|--------|-------------|-------------------|
| New files added | ~118 | ~108 (skip machvec + hpsim + hotplug) |
| Core ia64 files modified | 46 | **13** |
| Lines changed in core ia64 | +877/-259 | **+198/-10** |
| io.h changes | +189/-33 (full rewrite) | **+53 (ifdef block)** |
| setup.c changes | +36/-60 (removes code) | **+39/-4 (adds ifdef block)** |
| Supports CONFIG_IA64_GENERIC | Yes | No (dedicated SN2 build) |
| DIG/ZX1/UV/hpsim machvecs | Restored | Not needed |
| Forward-portability | Hard (46-file merge) | Easier (~13 small ifdefs) |
